...
require('top.php');					
?>
<div class="ht__bradcaump__area" style="background: rgba(0, 0, 0, 0) url(images/ban.jpg) no-repeat scroll center center / cover ;">
                    ...
                    <div class="col-lg-5 col-md-6 col-sm-12 col-xs-12">
                        ...
                        <div class="address">
                            ...
                            <div class="address__details">
                                ...
                                <p>Karachi Main Campus. Shah Latif Town (on National Highway). </p>
                            </div>
                        </div>
                        <div class="address">
                            <div class="address__icon">
